...
```typescript
import type { SocialContextUnion } from 'twitter-openapi-typescript-generated'
...
const exampleParsed = JSON.parse(exampleJSON) as SocialContextUnion
