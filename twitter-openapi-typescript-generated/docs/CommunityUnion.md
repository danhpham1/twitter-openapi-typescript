...
```typescript
import type { CommunityUnion } from 'twitter-openapi-typescript-generated'
...
const exampleParsed = JSON.parse(exampleJSON) as CommunityUnion
